...
Sub Actualizar()
    ...
    'en la primera carga de información y después de una actualizacion siempre se comineza de cero en este paso
    ...
    'Se juntan columnas Hernia, laminectomia y fijación
    
    desde = Array("Hernia Núcleo Pulposo Est TAGBORRAR", "Laminectomía Descompresiva TAGBORRAR", "Fijación De Columna CS Os TAGBORRAR")
